Feature: Verifisere KLAGNY Brev - TODO

  Scenario Outline: Verify if the KLAGNY Brev meets the baseline for Scenario <Scenario> in Language <Language>
    ...
    Examples:
      ...
      | "000059" | "KLAGNY" | "SC1"    | "NB"     |

      | "000059" | "KLAGNY" | "SC1"    | "NN"     |

      | "000059" | "KLAGNY" | "SC1"    | "EN"     |
